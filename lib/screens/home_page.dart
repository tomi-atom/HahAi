...
import 'package:hahai/screens/page_rekap.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  List<Map<String, dynamic>> medCat = [
    {"icon": 'assets/icon/fmasuk.png', "category": "Masuk"},
    {"icon": 'assets/icon/fpulang.png', "category": "Pulang"},
    {"icon": 'assets/icon/fabsensi.png', "category": "Kehadiran"},
    {"icon": 'assets/icon/flembur.png', "category": "Lembur"},
    {"icon": 'assets/icon/fsakit.png', "category": "Sakit"},
    {"icon": 'assets/icon/fcuti.png', "category": "Cuti"},
    {"icon": 'assets/icon/fizin.png', "category": "Izin Harian"},
    {"icon": 'assets/icon/fizin.png', "category": "Izin Keluar"},
    {"icon": 'assets/icon/fapproval.png', "category": "Approval Cuti"},
    {"icon": 'assets/icon/fapproval.png', "category": "Approval Lembur"},
    {"icon": 'assets/icon/fapproval.png', "category": "Approval Izin Harian"},
    {"icon": 'assets/icon/fapproval.png', "category": "Approval Izin Keluar"},
  ];
  ...
  Widget build(BuildContext context) {
    ...
    final formattedDate = DateFormat.yMMMMd('id_ID').format(currentDate);
    final formattedTime = DateFormat('HH:mm a').format(currentDate);
    return RefreshIndicator(
        onRefresh: _onRefresh, // Add your refresh function here
        child: Column(
          children: [
            Expanded(
              flex: 2,
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                SizedBox(width: 16.0), // Sesuaikan dengan jarak yang diinginkan antara kedua bagian
                                Row(
                                  children: [
                                    Icon(
                                      Icons.access_time,
                      ...
                      if (medCat[index]['category'] == 'Masuk') {
                        if (cekcuti.isNotEmpty) {
                          ...
                          ArtSweetAlert.show(
                            ...
                            artDialogArgs: ArtDialogArgs(
                              type: ArtSweetAlertType.warning,
                              title: "Warning",
                              text: "Anda Sedang Dalam Cuti Tidak Bisa Absen.",
                            ),
                          );
                        }
                        ...
                        if (hasSecurityRole) {
                          if (cekabsensi.isNotEmpty) {
                            ...
                            if ((tanggal.day == currentDate.day && tanggal.month == currentDate.month && tanggal.year == currentDate.year) ||
                                (tanggal.day == currentDate.day - 1 && tanggal.month == currentDate.month && tanggal.year == currentDate.year)) {
                              if (pulang == null) {
                        ...
                        ClipRRect(
                          ...
                          child: Card(
                            ...
                            child: Container(
                              ...
                              padding: EdgeInsets.all(8), // Tambahkan padding ke dalam Container
                              child: Container(
                                decoration: BoxDecoration(
                                  borderRadius: BorderRadius.circular(15),
                                  gradient: LinearGradient(
                                    ...
                                    colors: [
                                      Colors.white,
                                      Colors.grey.withOpacity(0.1), // Warna samar untuk efek bayangan
                                    ],
                                  ),
                                ),
                                child: Column(
