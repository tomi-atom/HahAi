...
class PageIzin extends StatefulWidget {
  const PageIzin({Key? key}) : super(key: key);

  @override
  State<PageIzin> createState() => _PageIzinState();
}

//enum for rambu kondisi
class _PageIzinState extends State<PageIzin> {
  ...
  Future<void> getIzin() async {
    ...
    final absensi = await dioProvider.getIzin(); // Use the initialized DioProvider
    if (absensi != 'Error') {
      setState(() {
        ...
        child: Column(
          ...
          children: <Widget>[
            FloatingActionButton(
                ...
                heroTag: null,
              onPressed: ()async{
                String refresh = await Navigator.push(context, MaterialPageRoute(builder: (context)=> InputIzin()));
            ...
            child: RefreshIndicator(
              ...
              artikel.isNotEmpty
                    ...
                    itemBuilder: (context, index) {
                                      ...
                                      children: article['persetujuan_izin']
                                        ...
                                        return Column(
                                          ...
                                          children: [
                                            ...
                                            // Add a divider between each approval
                                          ],
                                        );
                                      }).toList(),
                                    ),
                      ...
                      : Center(child: Text('Belum Ada Pengajuan Izin')),
              ),
                ],
              ),
            ),
