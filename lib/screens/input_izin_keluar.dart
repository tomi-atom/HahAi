...
class InputIzinKeluar extends StatefulWidget {
  @override
  _InputIzinKeluarState createState() => _InputIzinKeluarState();


}

class _InputIzinKeluarState extends State<InputIzinKeluar> {
  ...
  void initState() {
    super.initState();
    _tanggal = TextEditingController();
