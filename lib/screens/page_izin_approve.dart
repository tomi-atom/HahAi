...
class PageIzinApprove extends StatefulWidget {
  const PageIzinApprove({Key? key}) : super(key: key);

  @override
  State<PageIzinApprove> createState() => _PageIzinApproveState();
}

//enum for rambu kondisi
class _PageIzinApproveState extends State<PageIzinApprove> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: Text('Approval Izin Harian'),
      ),
      body: Container(
            ...
            child: RefreshIndicator(
              ...
              artikel.isNotEmpty
                    ...
                    itemBuilder: (context, index) {
                      ...
                      : Center(child: Text('Belum Ada Pengajuan Izin Harian yang Perlu disetujui')),
              ),
                ],
              ),
            ),
