...
class _InputLemburState extends State<InputLembur> {
  ...
  _submitReport() async {
    try {
      ...
      if (error is DioError) {
        _showErrorDialog('Terjadi kesalahan: ${(error.response != null) ? error.response?.statusCode : 'Unknown'}');
      } else {
        _showErrorDialog('Terjadi kesalahan: Unknown');
      }
  ...
  Future<void> _selectDate(BuildContext context, TextEditingController controller) async {
    ...
    DateTime maxDate = currentDate.add(Duration(days: 60));
